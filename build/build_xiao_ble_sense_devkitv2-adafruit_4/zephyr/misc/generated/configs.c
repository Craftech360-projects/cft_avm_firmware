...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_MAX_CONN_EVENT_LEN_DEFAULT, 400000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CONN_EVENT_EXTEND_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CENTRAL_ACL_EVENT_SPACING_DEFAULT, 400000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OFFLINE_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ACCELEROMETER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENABLE_BUTTON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENABLE_SPEAKER, 1);
